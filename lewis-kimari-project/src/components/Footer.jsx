        ...
        <footer>
            <section className="row p-5 fein ">
                ...
                <div className="col-md-4">
                    ...
                    <img src="/images/phone.png" alt="Phone" width="100px" height="60px" />
                    +254793990268 <br /><br />

                    <img src="/images/whatsapp.png" alt="WhatsApp" width="100px" height="60" />

                    +254793990268 <br /><br />


                    <img src="/images/email.jpeg" alt="Email" width="100px" height="60px" />
